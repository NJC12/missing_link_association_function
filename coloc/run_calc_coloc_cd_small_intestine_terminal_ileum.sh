...
cat > /net/data/GTEx/src/calc.coloc.$chr.$start.$end.cd.small_intestine_terminal_ileum.sh <<EOF2
#$ -S /bin/bash
#$ -e /net/data/GTEx/coloc/eo_files
#$ -o /net/data/GTEx/coloc/eo_files
#$ -l mf=7G
...
coloc/cd/regions/coloc.cd.small_intestine_terminal_ileum.$chr.$start.$end.txt \\
...
qsub -p 0 -l mf=7G /net/data/GTEx/src/calc.coloc.$chr.$start.$end.cd.small_intestine_terminal_ileum.sh
