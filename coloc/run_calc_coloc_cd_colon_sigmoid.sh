...
cat > /net/data/GTEx/src/calc.coloc.$chr.$start.$end.cd.colon_sigmoid.sh <<EOF2
#$ -S /bin/bash
#$ -e /net/data/GTEx/coloc/eo_files
#$ -o /net/data/GTEx/coloc/eo_files
#$ -l mf=7G
...
GTEx_Analysis_v7_QTLs/GTEx_Analysis_v7_eQTL_all_associations/colon_sigmoid/regions/colon_sigmoid.$chr.$start.$end.txt \\
coloc/cd/regions/coloc.cd.colon_sigmoid.$chr.$start.$end.txt \\
colon_sigmoid \\
86640  

EOF2

qsub -p 0 -l mf=7G /net/data/GTEx/src/calc.coloc.$chr.$start.$end.cd.colon_sigmoid.sh
