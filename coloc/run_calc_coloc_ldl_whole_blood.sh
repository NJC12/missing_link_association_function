...
cat > /net/data/GTEx/src/calc.coloc.$chr.$start.$end.ldl.whole_blood.sh <<EOF2
#$ -S /bin/bash
#$ -e /net/data/GTEx/coloc/eo_files
#$ -o /net/data/GTEx/coloc/eo_files
#$ -l mf=7G
...
GTEx_Analysis_v7_QTLs/GTEx_Analysis_v7_eQTL_all_associations/whole_blood/regions/whole_blood.$chr.$start.$end.txt \\
coloc/ldl/regions/coloc.ldl.whole_blood.$chr.$start.$end.txt \\
whole_blood \\
337489

EOF2

qsub -p 0 -l mf=7G /net/data/GTEx/src/calc.coloc.$chr.$start.$end.ldl.whole_blood.sh
