...
cat > /net/data/GTEx/src/calc.coloc.$chr.$start.$end.t2d.liver.sh <<EOF2
#$ -S /bin/bash
#$ -e /net/data/GTEx/coloc/eo_files
#$ -o /net/data/GTEx/coloc/eo_files
#$ -l mf=7G
...
coloc/t2d/regions/coloc.t2d.liver.$chr.$start.$end.txt \\
liver \\
132767

EOF2

qsub -p 0 -l mf=7G /net/data/GTEx/src/calc.coloc.$chr.$start.$end.t2d.liver.sh
