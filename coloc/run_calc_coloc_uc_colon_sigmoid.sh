...
cat > /net/data/GTEx/src/calc.coloc.$chr.$start.$end.uc.colon_sigmoid.sh <<EOF2
#$ -S /bin/bash
#$ -e /net/data/GTEx/coloc/eo_files
#$ -o /net/data/GTEx/coloc/eo_files
#$ -l mf=7G
...
coloc/uc/regions/coloc.uc.colon_sigmoid.$chr.$start.$end.txt \\
colon_sigmoid \\
86640  
...
qsub -p 0 -l mf=7G /net/data/GTEx/src/calc.coloc.$chr.$start.$end.uc.colon_sigmoid.sh
