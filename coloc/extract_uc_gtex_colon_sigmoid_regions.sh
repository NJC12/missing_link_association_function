...
mkdir -p /net/data/GTEx/GTEx_Analysis_v7_QTLs/GTEx_Analysis_v7_eQTL_all_associations/colon_sigmoid/regions
cd /net/data/GTEx/GTEx_Analysis_v7_QTLs/GTEx_Analysis_v7_eQTL_all_associations/colon_sigmoid
...
Colon_Sigmoid.chr$chr.txt \
> regions/colon_sigmoid.$chr.$start.$end.txt
